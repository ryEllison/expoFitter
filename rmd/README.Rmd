...
knitr::include_graphics('.\\static\\hex.jpg')
...
```{r, fig1, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = '25%', out.height = '25%'}

knitr::include_graphics('.\\static\\hex.png')
...
```{r, fig2, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = '25%', out.height = '25%'}
...
```{r, fig3, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = '25%', out.height = '25%'}
